...
func Match(matchers ...Matcher) *Layer {
	mx := New()
...
func Method(methods ...string) *Layer {
...
func Path(pattern string) *Layer {
...
func Host(pattern string) *Layer {
...
func Query(key, pattern string) *Layer {
...
func Header(key, pattern string) *Layer {
